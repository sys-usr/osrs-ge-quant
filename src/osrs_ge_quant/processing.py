...
def evaluate_processing_opportunities(df_24h: pd.DataFrame, skills: Dict[str, int]) -> pd.DataFrame:
    """
    ...
    skills: mapping like {"Herblore": 70, "Construction": 80, ...}
    ...
    for recipe in recipes:
        ...
        player_level = skills.get(required_skill, 1)
        if player_level < required_level:
            # Can't do this recipe yet
            continue
