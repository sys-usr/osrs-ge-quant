...
def build_terminal_snapshot(top_items: int = 100) -> dict[str, Any]:
    """
    Build an in-memory payload optimized for JS dashboards.
    """
...
def export_terminal_snapshot(output_path: Path, top_items: int = 100) -> Path:
    ...
    payload = build_terminal_snapshot(top_items=top_items)
